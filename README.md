...
![A run of a11yfix on demo/Card.tsx: three contrast errors with their measured ratios, and the line that says a clean run is not a conformance claim](docs/demo.svg)
